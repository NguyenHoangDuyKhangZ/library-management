...
const InventoryTable: React.FC<InventoryTableProps> = ({ inventory, onDeleteBook }) => {
  return (
              ...
              <tr key={book.id} className="group hover:bg-surface-variant/20 transition-colors">
                ...
                <td className="px-8 py-4 text-right">
                  <div className="flex justify-end gap-3">
                    ...
                    <button onClick={() => onDeleteBook(book.id)} className="p-2 text-slate-400 hover:text-error transition-colors hover:bg-error/10 rounded-lg">
