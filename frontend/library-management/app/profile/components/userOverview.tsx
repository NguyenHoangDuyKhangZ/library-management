...
const UserOverview: React.FC<UserOverviewProps> = ({ profile }) => {
    ...
    <section className="mb-12 flex flex-col md:flex-row items-center md:items-start gap-8 bg-white p-8 rounded-2xl border border-outline-variant shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex-1 text-center md:text-left">
        ...
        <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-4">
          <button className="vibrant-gradient-bg text-white px-6 py-3 rounded-xl font-bold text-sm shadow-md shadow-primary/20 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2">
